...
from ftxwebsocket_manager import WebsocketManager
...
class FtxWebsocketClient(WebsocketManager):
    ...
    def __init__(self) -> None:
        ...
        self._api_key = '_NxcNih4fRVB_Q9L3S2UEDqqFQr6OPNzU43CxRfI'  # TODO: Place your API key here
        self._api_secret = 'qxE45CI7OyUJW2YdFcg68QjVxCz9LqX2iTwEizbr'  # TODO: Place your API secret here
...
if __name__ == "__main__":
    ...
    while True:
        time.sleep(3)
        info = client.get_orderbook('BTC/USDT')
